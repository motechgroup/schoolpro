...
class StudentFeeController extends Controller {
    ...
    public function reconcile() {
        ...
        if ($classId) {
            ...
            // Get cumulative invoice info for each student
            foreach ($students as &$student) {
                $termSummary = $invoiceModel->getStudentTermBalances($student['id'], $academicYear);
                $student['invoices'] = $termSummary['invoices'] ?? [];
                $student['total_balance'] = $termSummary['net_balance'] ?? 0;
            }
        }
