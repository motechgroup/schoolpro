...
class ExaminationController extends Controller {
    ...
    public function reportCard($examinationId, $studentId) {
        ...
        if (!$isAdmin) {
            // Check for cumulative fee balance up to current examination term
            $currentYear = $examination['academic_year'];
            $cumulativeBalance = $invoiceModel->getCumulativeBalance($studentId, $examination['term'], $currentYear);
            
            // Block report card if net cumulative balance exists
