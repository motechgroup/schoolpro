                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="border rounded p-4 bg-blue-50">
                            <h4 class="font-semibold mb-3 text-blue-600">
                                <i class="fas fa-university mr-2"></i>KCB Bank
                            </h4>
                            <div class="mb-3">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Account Number *</label>
                                <input type="text" name="kcb_bank_account" 
                                       ...
                                       placeholder="Account number"
                                       required>
                                <p class="text-xs text-gray-500 mt-1">School's KCB Bank account number</p>
                            </div>
                            <div class="mb-3">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Account Name</label>
                            ...
                            <div class="border-t pt-3 mt-3">
                                <h5 class="font-semibold text-sm mb-2 text-blue-700">Buni API Configuration</h5>
                                <p class="text-xs text-gray-600 mb-3">
                                    Configure KCB Buni API to automatically fetch and reconcile transactions from KCB Bank.
                                    <a href="https://buni.kcbgroup.com/discover-apis" target="_blank" class="text-blue-600 underline">View API Documentation</a>
                                </p>
                                
                                <div class="mb-3">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Client ID *</label>
                                    <input type="text" name="kcb_buni_client_id" 
                                           value="<?php echo htmlspecialchars($settings['kcb_buni_client_id'] ?? ''); ?>" 
                                           class="w-full border rounded px-3 py-2"
                                           placeholder="Your Buni API Client ID">
                                </div>
                                
                                <div class="mb-3">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Client Secret *</label>
                                    <input type="password" name="kcb_buni_client_secret" 
                                           value="<?php echo htmlspecialchars($settings['kcb_buni_client_secret'] ?? ''); ?>" 
                                           class="w-full border rounded px-3 py-2"
                                           placeholder="Your Buni API Client Secret">
                                </div>
                                
                                <div class="mb-3">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Environment</label>
                                    <select name="kcb_buni_environment" class="w-full border rounded px-3 py-2">
                                        <option value="sandbox" <?php echo ($settings['kcb_buni_environment'] ?? 'sandbox') == 'sandbox' ? 'selected' : ''; ?>>Sandbox (Testing)</option>
                                        <option value="production" <?php echo ($settings['kcb_buni_environment'] ?? '') == 'production' ? 'selected' : ''; ?>>Production (Live)</option>
                                    </select>
                                </div>
                                
                                <div class="mt-3">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="kcb_buni_auto_reconcile" 
                                               value="1"
                                               <?php echo ($settings['kcb_buni_auto_reconcile'] ?? '0') == '1' ? 'checked' : ''; ?>
                                               class="mr-2">
                                        <span class="text-sm text-gray-700">Enable automatic transaction reconciliation</span>
                                    </label>
                                    <p class="text-xs text-gray-500 mt-1 ml-6">
                                ...
                                <div class="mt-3">
                                    <a href="<?php echo BASE_URL; ?>/kcbbank" 
