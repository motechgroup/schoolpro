        ...
        <form id="assignForm">
            ...
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-600 mb-4">
                    Select fee heads to assign to this student. The system will use the default amount for each fee head (as defined in fee head settings). You can change fee head assignments at any time.
                    <br><span class="text-yellow-700 font-semibold"><i class="fas fa-info-circle mr-1"></i>Note: Fee heads with existing payments are locked and cannot be changed or removed.</span>
                    <br><span class="text-blue-700 font-semibold"><i class="fas fa-info-circle mr-1"></i>Tip: You can uncheck and recheck fee heads to change assignments (as long as there are no payments).</span>
                </p>
                ...
                <div class="space-y-3">
                    <?php foreach ($feeHeads as $feeHead): 
                        ...
                        // Only lock fee heads that have payments - allow editing of assignments without payments
                        $isLocked = $hasPayments;
                    ?>
