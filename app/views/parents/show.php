        ...
        <div class="md:col-span-2 bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-lg font-semibold"><?php echo displayText($parent['first_name'] . ' ' . $parent['last_name']); ?></p>
                </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <?php echo displayText($child['first_name'] . ' ' . $child['last_name']); ?>
                        </td>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            ...
                            echo displayText($student['first_name'] . ' ' . $student['last_name']);
                            ?>
                        </td>
    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-bold">Send SMS to <?php echo displayText($parent['first_name'] . ' ' . $parent['last_name']); ?></h3>
