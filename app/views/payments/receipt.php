    ...
    <div class="receipt">
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <span class="info-value"><?php echo htmlspecialchars(($payment['student_first_name'] ?? '') . ' ' . ($payment['student_middle_name'] ?? '') . ' ' . ($payment['student_last_name'] ?? '')); ?></span>
            </div>
        ...
        <div class="footer">
            ...
            <div style="margin-bottom: 5px;">
                Received by: <?php echo htmlspecialchars(($payment['received_by_first_name'] ?? '') . ' ' . ($payment['received_by_last_name'] ?? '')); ?>
            </div>
            <?php endif; ?>
