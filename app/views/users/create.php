    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form id="userForm">
            ...
            <div class="mt-6 flex justify-end space-x-4">
                <a href="<?php echo BASE_URL; ?>/users" class="bg-gray-500 text-white px-6 py-2 rounded hover:bg-gray-600">
                    Cancel
                </a>
...
document.getElementById('userForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('<?php echo BASE_URL; ?>/users/store', {
            method: 'POST',
            body: formData
        });
