            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="code" required 
                           ...
                           maxlength="20">
                    <p class="text-xs text-gray-500 mt-1">Unique code for this subject</p>
                </div>
                ...
                <div>
                    ...
                    <select name="grade_id" required class="w-full border rounded px-3 py-2">
                        ...
                        <option value="<?php echo $grade['id']; ?>" 
                                <?php echo ($subject['grade_id'] == $grade['id']) ? 'selected' : ''; ?>>
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" 
                              ...
                              class="w-full border rounded px-3 py-2"><?php echo htmlspecialchars($subject['description'] ?? ''); ?></textarea>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo BASE_URL; ?>/subjects/update/<?php echo $subject['id']; ?>', {
            method: 'POST',
            body: formData
        })
